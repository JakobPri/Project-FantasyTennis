class FantasyTennis {
    constructor() {
        ...
        this.playerGuesses = {}
        this.playerButtons = document.getElementsByClassName("playerButton")
    ...
    clickEventHandlerSetup() {
        ...
        for (let button of playerButtons) {
            button.onclick = () => {
                ...
                this.playerGuesses[nextDrawId + "-" + nextGameId + "-" + nextButtonId] = event.target.innerText
                this.pointCounter = this.pointCounter + Math.random()*4
        ...
        this.submitButton.onclick = () => {
            ...
            console.log(this.playerButtons.length)
            for (let i = 0; i < this.playerButtons.length-this.drawSize; i++) {
                if (Math.random() > 0.5) {
                    this.playerButtons[i + this.drawSize].style.background = "red";
                } else {
                    this.playerButtons[i + this.drawSize].style.background = "green";
